/**
 * AgentNodeCustom - Individual agent node component
...
const AgentNodeCustom = memo(({ id, data, selected }) => {
...
AgentNodeCustom.displayName = 'AgentNodeCustom';

export default AgentNodeCustom;
